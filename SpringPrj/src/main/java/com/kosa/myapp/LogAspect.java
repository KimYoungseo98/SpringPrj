...
public class LogAspect {
	@Pointcut(value = "execution(* com.kosa..*.sayHello(..))")
	private void helloPointcut() {
	}

	@Pointcut(value = "execution(* com.kosa..*.sayGoodby(..))")
	...
	public Object afterReturningLog(JoinPoint joinPoint, String message) {
		...
		System.out.println("[Log: AfterRetruning] 메서드 리턴값: " + message);
		return message;
	}
